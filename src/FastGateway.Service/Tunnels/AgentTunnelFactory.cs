...
public partial class AgentTunnelFactory(ILogger<AgentTunnelFactory> logger)
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        if (this._httpTunnelCompletionSources.TryAdd(tunnelId, httpTunnelSource) == false)
        {
        ...
        {
            this._httpTunnelCompletionSources.TryRemove(tunnelId, out _);
        }
    }

    public bool Contains(Guid tunnelId)
    {
        return this._httpTunnelCompletionSources.ContainsKey(tunnelId);
    }

    public bool SetResult(HttpTunnel httpTunnel)
    {
        return this._httpTunnelCompletionSources.TryRemove(httpTunnel.Id, out var source) &&
