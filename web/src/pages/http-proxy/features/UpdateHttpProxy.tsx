...
export default function UpdateHttpProxy({
    visible,
    onClose,
    onOk,
    values
                    ...
                    ({ values, formApi }: IFormValues) => (
                        <>
                            ...
                            <div style={{
                                ...
                                <Button block>添加服务</Button>
                            </div>

                            <Collapse>
                                {
                                    values.locations?.map((location: LocationInput, index: number) => {
                                        return (<Collapse.Panel header={location.serviceNames.length == 0 ? "未填写域名" : location.serviceNames.map(x => {
                                            return <Tag >{x}</Tag>;
                                            ...
                                            <Select
                                                field="serviceNames"
                                                label="域名"
                                                initValue={location.serviceNames}
                                                rules={[{
                                                    required: true,
                                                    message: '域名不能为空',
                                                }]}
                                            ...
                                            <Collapse>
                                                {
                                                    location.locationService.map((service, index) => {
                                                        return (<Collapse.Panel itemKey={"location-service" + index.toString()} header={service.path === '' ? "未填写路由" : service.path} key={index} style={{}}>
                                                            <Input
                                                                label="路由绑定"
